...
void app_config_http_send_registers_form(struct netconn *conn)
{
  ...
  http_write(conn,
    ...
    "<a class='nav-item' href='/modbus_values.html'><span class='material-symbols-outlined' style='font-variation-settings: \'FILL\' 1;'>chat</span>Live Readings</a>"
		  "<details class='menu' open><summary class='nav-item active'><span class='material-symbols-outlined'>build</span>Maintenance</summary><div class='menu-links'>"
		     "<a class='menu-link' href='/modbus_config_port.html'><span class='bullet'></span>Port</a>"
		     "<a class='menu-link ' href='/modbus_config_slaves.html'><span class='bullet'></span>Slaves</a>"
		     "<a class='menu-link active' href='/modbus_config_registers.html'><span class='bullet'></span>Registers</a>"
		     "</div></details>"
		  "</nav>"
    "<div class='sidebar-footer'><div class='status-pill'><div class='status-icon'>SN04</div><div class='status-text'><p>System Status</p><p>Nominal</p></div></div></div>"
    "</aside>"
...
void app_config_http_send_values(struct netconn *conn)
{
  ...
  http_write(conn,
    "<div class='page-header'><div class='page-title'><h2>Modbus Values</h2><p>Real-time supervision and alarm management of hospital electrical infrastructure.</p></div></div>"
